...
void ACYPlayerController::BeginPlay()
{
    ...
    if (UEnhancedInputLocalPlayerSubsystem* Subsystem = ULocalPlayer::GetSubsystem<UEnhancedInputLocalPlayerSubsystem>(LocalPlayer))
    {
        if (DefaultMappingContext)
        {
            ...
            UE_LOG(LogTemp, Warning, TEXT("✅ Enhanced Input Mapping Context added"));
        }
        else
        {
...
void ACYPlayerController::SetupInputComponent()
{
    ...
    if (UEnhancedInputComponent* EnhancedInput = Cast<UEnhancedInputComponent>(InputComponent))
    {
        ...
        if (InteractAction)
        {
            ...
            UE_LOG(LogTemp, Warning, TEXT("✅ Interact Action bound"));
        }
        else
        {
    ...
    {
        UE_LOG(LogTemp, Warning, TEXT("🔄 Using Legacy Input Component as backup"));
        ...
        UE_LOG(LogTemp, Warning, TEXT("✅ Legacy Input keys bound"));
    }
}
...
{
    UE_LOG(LogTemp, Warning, TEXT("🔑 InteractPressed called in PlayerController!"));
    
    if (ACYPlayerCharacter* PlayerCharacter = Cast<ACYPlayerCharacter>(GetPawn()))
    {
        UE_LOG(LogTemp, Warning, TEXT("🔑 PlayerCharacter found, calling InteractPressed..."));
...
void ACYPlayerController::PrimaryAttackPressed()
{
    ...
    {
        UE_LOG(LogTemp, Warning, TEXT("🖱️ Weapon found, calling ServerAttackPressed..."));
        ServerAttackPressed();
    }
    else
    {
        UE_LOG(LogTemp, Warning, TEXT("🖱️ No weapon equipped, skipping attack"));
    }
}

void ACYPlayerController::ServerAttackPressed_Implementation()
{
    UE_LOG(LogTemp, Warning, TEXT("🖱️ ServerAttackPressed called on server"));
